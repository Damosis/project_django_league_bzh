...
def rank(request, league_id):
    try:
        ...
        participants_dict_matches = {
            p.id: [0, 0, 0, 0, p.first_name, p.last_name, 0, p.reg_date]
        ...
        for m in matchs:
            ...
            if m.score_local > m.score_visitor:
                participants_dict_matches[m.local.id] = [
                    lst_local[0] + 1,
                    lst_local[1],
                    lst_local[2],
                    lst_local[3] + 3,
                    lst_local[4],
                    lst_local[5],
                    lst_local[6] + m.score_local,
                    lst_local[7],
                ]
                participants_dict_matches[m.visitor.id] = [
                    lst_visitor[0],
                    lst_visitor[1] + 1,
                    lst_visitor[2],
                    lst_visitor[3],
